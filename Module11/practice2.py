...
class HourlyPaid(Employee):#Write the name of the base class in the parentheses following the subclass.
    def __init__(self, first_name, last_name, hourly_pay):
        self.hourly_pay = hourly_pay
        super().__init__(first_name, last_name)#calls the initializer of the base class that receives the first and last name as parameters
